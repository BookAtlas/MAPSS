 ...
 * @author Tolise
 */
public class FNewVehicle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Taurus");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Focus");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Mustang");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("F-150");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FNewVehicle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
