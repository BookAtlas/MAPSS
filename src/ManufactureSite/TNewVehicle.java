 ...
 * @author Tolise
 */
public class TNewVehicle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton2.setText("Camry");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Prius");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Tundra");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TNewVehicle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
