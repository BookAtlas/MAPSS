 ...
 * @author Tolise
 */
public class DNewVehicle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Safety Features");
        ...
        jRadioButton1.setText("Dart");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Charger");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Challenger");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Durango");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DNewVehicle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
