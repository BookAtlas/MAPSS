 ...
 * @author Tolise
 */
public class FordCarView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FordCarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
