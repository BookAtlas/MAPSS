 ...
 * @author Tolise
 */
public class ChevyCarView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chevrolet Database");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChevyCarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
