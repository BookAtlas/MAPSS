 ...
 * @author Tolise
 */
public class DodCarView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dodge Database");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DodCarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
